<template>
    <div v-if="reviews" class="flex flex-col gap-6">
        <div v-for="review in reviews" :key="review.idavis" >
            <SingleComment :id="review.idavis" :comment="review.commentaire" :note="review.note" :date="review.dateavis" :title="review.titreavis"/>         
            <div class="mt-2">
            ...
            <button @click="reponse(review.idavis)" class="bg-green-500 hover:bg-green-700 text-white font-bold mt-2 py-2 px-4 rounded">
                Répondre
            </button>
