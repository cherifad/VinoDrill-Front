    ...
    <div class="flex gap-3">
      ...
      <div class="w-1/4 sticky top-5 border-2 border-rose rounded-2xl flex flex-col gap-5 items-center h-fit">
        <div class="p-12 text-center">
          ...
          <button @click="checkBeforeCheckout" class="flex mb-6 w-full text-xl justify-center cursor-pointer select-none rounded-md ease-linear duration-300 items-center gap-3 p-3 bg-rose border-rose border-2 hover:bg-transparent font-semibold">
          ...
          <button @click="addAvis = !addAvis" class="flex w-full text-xl justify-center cursor-pointer select-none rounded-md ease-linear duration-300 items-center gap-3 p-3 bg-rose border-rose border-2 hover:bg-transparent font-semibold">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
