...
<template>
  <header id="top" class="w-full absolute top-0 z-50 px-10 pt-10">
    <div class="flex w-full justify-between">
      ...
      <div class="flex text-2xl text-white items-center gap-3">
        ...
        <RouterLink v-else to="/mon-compte" class="hover:text-opacity-90 flex gap-2 items-center">Bonjour {{ authStore.user.prenomclient }}
  ...
  <footer class="p-4 sm:p-6 mt-6 bg-rouge">
      <div class="md:flex md:justify-between">
          <div class="mb-6 md:mb-0">
              <a href="https://flowbite.com/" class="flex items-center">
                  <img src="./assets/img/favicon.ico" class="mr-3 h-8" alt="FlowBite Logo" />
                  <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">VinoDrill</span>
              </a>
          </div>
          <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              ...
              <div>
                  ...
                  <ul class="text-gray-600 dark:text-gray-400">
                      ...
                      <li>
                        <RouterLink to="/gestion-des-cookies">Gestion des cookies</RouterLink>
                      </li>
                  </ul>
              </div>
          </div>
      ...
      <div class="sm:flex sm:items-center sm:justify-between">
          <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">2023 <a href="https://flowbite.com/" class="hover:underline">Vinodrill</a>. Aucun droit réservé.
          </span>
          <div class="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
              <a href="https://www.facebook.com/vinotrip" target="_blank" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                  <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path fill-rule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clip-rule="evenodd" /></svg>
                  <span class="sr-only">Facebook page</span>
              </a>
              <a href="https://www.instagram.com/vinotrip/" target="_blank" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
              ...
              <a href="https://twitter.com/vinotrip" target="_blank" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
