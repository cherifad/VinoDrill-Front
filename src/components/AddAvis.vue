...
<template>
     <form @submit="" class="w-full">
        ...
        <div class="flex  gap-6 items-center justify-center w-full mb-6" v-auto-animate>
            <label v-if="pictures.length <= 5" for="dropzone-file" class="flex min-w-fit flex-1 flex-col items-center justify-center h-64 border-2 px-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
            ...
            <div v-if="pictures.length > 0" class="h-fit relative flex flex-wrap w-auto border gap-2 border-gray-300 border-dashed" v-auto-animate> 
